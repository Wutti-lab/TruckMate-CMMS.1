    ...
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Card>
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <CardTitle className="text-sm font-medium">Inspektionen Total</CardTitle>
      ...
      <Card>
        <CardHeader className="flex flex-row items-center justify-between pb-2">
          <CardTitle className="text-sm font-medium">Überfällige Inspektionen</CardTitle>
        ...
        <CardContent>
          ...
          <div className="flex items-center text-orange-500 mt-2">
            ...
            <span className="text-xs">Erfordern Aufmerksamkeit</span>
          </div>
        </CardContent>
      </Card>
    </div>
